...
The public bring-up fixture reuses the example applications, forms, fonts,
theme and animations. Its Wi-Fi editor is the explicitly labeled M2 simulation. Clock displays --:-- until a
...
fallback/reconnect fault tests or completion of M3. That initial fixture used simulated Wi-Fi editing and radio indicators.
Later private compositions can use real adapters; see the
[current evidence register](../docs/DISPLAY-CATALOG.md#tested-devices) and
[primary Wi-Fi adapter](../external_components/nabla_wifi/README.md).
The initial test figures below are historical, not measurements of current firmware.
