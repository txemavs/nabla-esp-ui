...
ACTIONS = {"open", "dark", "light", "wifi_demo", "wifi", "forms_demo", "toggle_dark", "toggle_font", "toggle_borders", "command"}
...
def emit(tree):
    ...
    for n in nodes:
        values = [json.dumps(n["title"], ensure_ascii=False), str(n["parent"]),
                  ...
                  str({"open": 0, "dark": 1, "light": 2, "wifi_demo": 3, "wifi": 3, "forms_demo": 4, "toggle_dark": 5, "toggle_font": 6, "toggle_borders": 7, "command": 8}[n["action"]]),
